<script>
    ...
    const successProfiles = [
        ...
        { image: "founder.png", name: "Mr Vishvakraj", title: "Govt of California, USA" },
        { image: "p5.png", name: "Mr Anirudh", title: "Net Health, USA" },
        { image: "a4.png", name: "Mr Ramesh", title: "Mugavari Foundation" }
    ];
