<script>
    ...
    const successProfiles = [
        { image: "a1.png", name: "Mr Arumugam", title: "Biology Teacher, TN Govt School" },
        { image: "a2.png", name: "Mr Karthik Babu", title: "Manhattan Associates, USA" },
        { image: "krithika.png", name: "Mrs Krithika", title: " USA" },
        { image: "p2.png", name: "Mr Uday", title: "Entrepreneur, USA" },
        { image: "a5.png", name: "Mr Uday", title: " USA" }
    ];
